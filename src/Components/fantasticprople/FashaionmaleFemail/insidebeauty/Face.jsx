// Date:08/20/2023
// Author: MASUM
// Description: display Face product
...
const Face = () => {
    ...
    // filter only Face related data
    const faceProducts = products.filter(face => face.category === "beauty" && face.product==="face")
    ...
    return (
        <section>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-5 gap-y-10 lg:mx-20 my-10'>
                {/* {
                    faceProducts.map(face => <CardsOfProducts singleProduct={face}/>)
                } */}
            </div>
