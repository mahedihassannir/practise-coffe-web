            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-8">
                <Link to='/food'>
                    <div className="w-[140px] mb-2 hover:shadow-md hover:rounded-md px-2 py-2 ">
                        <div className="flex justify-center items-center ">
                            <img className="pt-2" src="https://i.ibb.co/7jwt6sH/6b396809-87e7-435d-ba7b-5d69699371ba.png" alt="" />
                        </div>
                ...
                <Link to='/fashion'>
                    <div className="w-[140px] hover:shadow-md hover:rounded-md px-2 py-2 mb-2">
                        <div className="flex justify-center items-center ">
                            <img className="pt-2" src="https://i.ibb.co/qNNNSkV/773d0210-eda1-4fd6-8b8d-a92dafbe23bd.png" alt="" />
                        </div>
                ...
                <Link to='/beauty'>
                    <div className="w-[140px] hover:shadow-md hover:rounded-md px-2 py-2 mb-2">
                        <div className="flex justify-center items-center ">
                            <img className="pt-2" src="https://i.ibb.co/qWHkXH0/d336362c-7d67-4b22-9f96-3b2a60297e0f.png" alt="" />
                        </div>
